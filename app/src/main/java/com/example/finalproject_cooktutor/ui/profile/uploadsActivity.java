...
public class uploadsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new sendUploadsActivity().execute("uploads",usernameMSG,"");
    }


    class sendUploadsActivity extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result){
            if(result.contains("Failed")){
                Toast.makeText(uploadsActivity.this, "Failed to connect to server", Toast.LENGTH_SHORT).show();
            }else{
                ...
                myListView.setAdapter(new ArrayAdapter<String>(uploadsActivity.this, android.R.layout.simple_list_item_activated_1, infos));
                myListView.setTextFilterEnabled(true);

                myListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                    @Override
                    public void onItemClick (AdapterView < ? > adapter, View view,int position, long arg) {
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(uploadsActivity.this);
